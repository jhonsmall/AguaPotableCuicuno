...
@Component({
    selector: 'jhi-recibo-my-suffix',
    templateUrl: './recibo-my-suffix.component.html'
})
export class ReciboMySuffixComponent implements OnInit, OnDestroy {

    recibos: ReciboMySuffix[];
    currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.reciboService.search({
                ...
                (res: HttpResponse<ReciboMySuffix[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: ReciboMySuffix) {
        return item.id;
    }
