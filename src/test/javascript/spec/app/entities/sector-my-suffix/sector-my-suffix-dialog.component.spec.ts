...
import { SectorMySuffixDialogComponent } from '../../../../../../main/webapp/app/entities/sector-my-suffix/sector-my-suffix-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('SectorMySuffix Management Dialog Component', () => {
        let comp: SectorMySuffixDialogComponent;
        let fixture: ComponentFixture<SectorMySuffixDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [SectorMySuffixDialogComponent],
                providers: [
                    SectorMySuffixService
                ]
            })
            .overrideTemplate(SectorMySuffixDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(SectorMySuffixDialogComponent);
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new SectorMySuffix(123);
            ...
            it('Should call create service on save for new entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new SectorMySuffix();
